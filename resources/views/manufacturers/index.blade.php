                            ...
                            <table class="table  table-nowrap card-table">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col">
                                    <a href="#" class="text-muted sort" data-sort="address">address</a>
                                  </th>
                                  <th scope="col">
                                    <a href="#" class="text-muted sort" data-sort="website">website</a>
                                  </th>
                              ...
                              <tbody class="list">
                                ...
                                <tr>
                                  ...
                                  <td  class="no">{{$manufacturer->id}}</td>
                             
                                  <td class="name">{{$manufacturer->name}}</td>
                                  <td class="contact">{{$manufacturer->contact}}</td>
                                  <td class="address">{{$manufacturer->address}}</td>
                                  <td class="website">{{$manufacturer->website?$manufacturer->website:"___"}}</td>
                                
                                  <td class="date"><time>{{$manufacturer->created_at->format('d M Y')}}</time></td>
                                        ...
                                        <td class="text-right">
                                                <div class="dropdown">
                                                  ...
                                                  <a href="{{route('manufacturers.show',$manufacturer->id)}}" class="dropdown-item">
                                                      view
                                                    </a>
